...
export async function POST(request) {
  try {
    ...
    const adminEmailData = await resend.emails.send({
      from: "info@robotechsummit.com",
      to: "info@robotechsummit.com", // Admin email
      subject: `RobotechSummit | New Contact Form Submission: ${subject}`,
    ...
    const userEmailData = await resend.emails.send({
      ...
      subject: "RobotechSummit | Thank you for contacting us",
