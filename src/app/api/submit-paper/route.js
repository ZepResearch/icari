...
export async function POST(request) {
  try {
    ...
    const record = await pb.collection("ICAIR_paper_form_submission").create(pbFormData)
    ...
    await resend.emails.send({
      from: "Conference <info@robotechsummit.com>",
      to: data.email,
      subject:
        "Paper Submission Confirmation - robotechsummit 2025",
    ...
    await resend.emails.send({
      ...
      subject: "New Paper Submission - robotechsummit 2025",
