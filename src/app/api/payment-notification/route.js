...
export async function POST(req) {
  try {
    ...
    await resend.emails.send({
      from: process.env.FROM_EMAIL || "info@robotechsummit.com",
      to: process.env.ADMIN_EMAIL || "info@robotechsummit.com",
    ...
    await resend.emails.send({
      ...
      subject: "Payment Initiated for RobotechSummit Registration",
