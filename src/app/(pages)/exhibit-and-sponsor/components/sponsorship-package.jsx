  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white rounded-3xl border border-gray-200 overflow-hidden h-full transition-all group-hover:bg-gray-50">
        ...
        {title === "Gold" && (
          <div className="absolute -right-12 top-6 bg-gradient-to-r from-rose-400 to-orange-300 text-white text-xs font-bold py-1 px-12 transform rotate-45 z-10 shadow-md">
            Most Popular
          </div>
        )}
        ...
        <div className="p-6 flex flex-col h-full">
          ...
          <Button
            onClick={onSelect}
            className="w-full bg-gradient-to-r from-rose-400 to-orange-300 hover:brightness-110 text-white rounded-full border-0"
          >
