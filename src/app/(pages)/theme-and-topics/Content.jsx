...
export default function ThemeAndTopicsPage() {
  const researchAreas = [
    ...
    },
    {
      ...
      title: "AI & Robotics in Real-world Applications",
      topics: [
        "Healthcare Robotics and AI in Medical Diagnosis",
        "AI in Smart Manufacturing and Industry 5.0",
        "Agricultural Robotics and AI in Agritech",
        "AI & Robotics in Space and Defense",
      ],
    },
    {
      ...
      topics: [
        ...
        "Sensor Integration and Intelligent Perception",
        "Simulation, Digital Twins & Virtual Robotics",
      ],
    },
    {
      icon: <Globe className="h-8 w-8 text-orange-600" />,
      title: "Ethics, Governance & Sustainable AI",
      topics: [
        "Responsible AI and Algorithmic Bias",
        "Robotics and AI for Social Good",
        "Regulatory Frameworks & AI Safety",
        "AI & Robotics in Climate Action and Sustainability",
      ],
    },
  ]
