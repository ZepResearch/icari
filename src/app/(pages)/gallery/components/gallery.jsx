        ...
        {images.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition-all duration-300 ${
              index === currentIndex
                ? "bg-gradient-to-r from-orange-400 via-red-500 to-yellow-400 w-8"
        ...
        {videos.map((video) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/30 to-transparent flex items-center justify-center">
              <div className="bg-white/90 p-4 rounded-full transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-orange-400 group-hover:via-red-500 group-hover:to-yellow-400 group-hover:scale-110">
...
const firstConferenceImages = [
  {
    src: "/gallery/1.jpg",
    alt: "AI & Robotics Conference - Opening Ceremony",
  },
  {
    src: "/gallery/2.jpg",
    alt: "AI & Robotics Conference - Keynote Speaker",
  },
  {
    src: "/gallery/3.jpg",
    alt: "AI & Robotics Conference - Panel Discussion",
  },
  {
    src: "/gallery/4.jpg",
    alt: "AI & Robotics Conference - Robotics Demo",
  },
  {
    src: "/gallery/5.jpg",
    alt: "AI & Robotics Conference - Innovation Showcase",
  },
  {
    src: "/gallery/6.jpg",
    alt: "AI & Robotics Conference - Award Ceremony",
  },
  {
    src: "/gallery/7.jpg",
    alt: "AI & Robotics Conference - Networking Session",
  },
  {
    src: "/gallery/8.jpg",
    alt: "AI & Robotics Conference - Workshop",
  },
  {
    src: "/gallery/9.jpg",
    alt: "AI & Robotics Conference - Tech Exhibition",
  },
  {
    src: "/gallery/10.jpg",
    alt: "AI & Robotics Conference - Group Photo",
  },
  {
    src: "/gallery/11.jpg",
    alt: "AI & Robotics Conference - Closing Ceremony",
  },
]
  ...
  return (
    <div className="relative min-h-screen bg-white text-gray-800 py-12 px-4 md:px-8">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-10 left-10 w-64 h-64 bg-gradient-to-r from-orange-200 via-red-200 to-yellow-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
        <div className="absolute bottom-10 right-10 w-80 h-80 bg-gradient-to-r from-yellow-200 via-orange-200 to-red-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
        <div className="absolute top-1/3 right-1/4 w-40 h-40 bg-gradient-to-r from-red-200 to-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20"></div>
      </div>
        ...
        <div className="space-y-16">
          ...
          <section className="bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50 rounded-2xl p-6 md:p-8 shadow-xl border border-orange-100 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-200/50">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-red-600 to-yellow-500">
                1st 
International conference on
AI & Robotics Innovation
              </h2>
              <p className="text-gray-700 mt-2 max-w-3xl mb-6">
                Highlights from our inaugural conference showcasing groundbreaking research and innovation in
          ...
          {/* Second Conference Section - Commented out */}
          {/* <section className="bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50 rounded-2xl p-6 md:p-8 shadow-xl border border-orange-100 transition-all duration-300 hover:shadow-2xl hover:shadow-orange-200/50">
            <div>
              <div className="inline-block px-3 py-1 mb-3 text-xs font-semibold tracking-wider text-white bg-gradient-to-r from-orange-400 via-red-500 to-yellow-400 rounded-full">
                FOLLOW-UP EVENT
        ...
        <footer className="mt-20 text-center text-gray-600">
          <p>© {new Date().getFullYear()} International Conference on AI & Robotics Innovation</p>
          <p className="mt-2 text-sm">
            Bringing together researchers, practitioners, and innovators in artificial intelligence and robotics
          </p>
        </footer>
      </div>
    </div>
