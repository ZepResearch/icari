...
export default function PaperSubmissionPage() {
  ...
  return (
    <main className="bg scroll-smooth">
      ...
      <section className="relative pt-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-4">
            ...
            <a href="#guid" className="scroll-smooth transition-all py-2 px-3 bg-orange-400 rounded-4xl text-white font-semibold hover:drop-shadow-2xl hover:bg-orange-500/90">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        <input
                          ...
                          required
                          accept=".doc,.docx"
                          className="w-full px-4 py-3 bg-gray-100 shadow-2xs border  rounded-xl text-[#1a2e1a] focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-orange-500/80 file:text-gray-100  hover:file:bg-orange-500/60"
                        />
                  ...
                  <div className="flex justify-center pt-4">
                    <button
                      ...
                      className="relative px-8 py-4 bg-orange-500 hover:bg-orange-500/50 text-gray-100 shadow-2xs font-medium rounded-full focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-[#edf6e1] disabled:opacity-50 disabled:cursor-not-allowed group overflow-hidden"
                    >
      ...
      <section className="py-8">
        <div className="container mx-auto px-4 ">
          <div className="max-w-2xl mx-auto ">
            <div className="bg-orange-50/50 shadow-2xl border-l-4 border-orange-400 p-6 rounded-2xl  flex items-center gap-4">
              <svg className="h-8 w-8 text-orange-500 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12c0 4.97-4.03 9-9 9s-9-4.03-9-9 4.03-9 9-9 9 4.03 9 9z" /></svg>
              <div>
                <p className="text-lg font-semibold text-orange-700 mb-1">Facing issues submitting?</p>
                <p className="text-orange-800">If you have any trouble submitting your paper, please email us at <a href="mailto:info@robotechsummit.com" className="underline font-medium">info@robotechsummit.com</a>.</p>
              </div>
            </div>
          </div>
        </div>
