          ...
          <div className="px-8 py-6 space-y-8">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-700 leading-relaxed">
                The  International conference on AI & Robotics Innovation (ICARI 2025) is committed to fostering an inclusive, accessible, and discrimination-free environment for all participants, regardless of physical, sensory, intellectual, or mental health conditions.
              </p>
            </div>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ICARI 2025 strictly prohibits any form of discrimination, harassment, or exclusion based on disability. All conference organizers, staff, and participants are expected to support and uphold the principles of inclusivity and equal access to conference activities, both in physical and virtual formats.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 mb-4">
                ICARI 2025 will provide reasonable accommodations to ensure the full participation of individuals with disabilities, which may include:
              </p>
              ...
              <div className="mt-4 p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500">
                <p className="text-gray-700 text-sm">
                  <strong>Note:</strong> Participants requiring accommodations are encouraged to notify the Organizing Committee in advance via info@ICARI.in to ensure timely arrangements.
                </p>
              </div>
            </section>
