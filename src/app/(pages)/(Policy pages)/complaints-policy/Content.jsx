    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          {/* Page Header */}
          <div className="bg-gradient-to-r from-orange-500 to-orange-700 px-8 py-6">
          ...
          <div className="px-8 py-8 space-y-8">
            {/* Section 1 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">1. Introduction</h2>
              <p className="text-gray-700 leading-relaxed">
                The Organizing Committee of the International Conference on AI & Robotics Innovation
                (ICARAI) is committed to providing a professional, respectful, and inclusive environment for all
            ...
            {/* Section 2 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">2. Scope of the Policy</h2>
            ...
            {/* Section 3 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">3. Lodging a Complaint</h2>
              ...
              <div className="bg-orange-50 border-l-4 border-[#805505] p-4 rounded">
                <p className="text-gray-700">
                  <strong>Complaints should be sent via email to:</strong> info@robotechsummit.com
                </p>
                <p className="text-gray-700 mt-2">
                  <strong>Subject line:</strong> Formal Complaint – ICARAI 2025
                </p>
              </div>
            </section>
            ...
            {/* Section 4 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">4. Complaint Review Process</h2>
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">5. Resolution and Outcomes</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* Section 6 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">6. Confidentiality</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Section 7 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">7. Appeals</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            {/* Section 8 */}
            <section>
              <h2 className="text-xl font-bold text-orange-600 mb-4">8. Contact Information</h2>
              ...
              <div className="flex flex-col space-y-3">
                <div className="flex items-center space-x-3 text-orange-800">
                  ...
                  <span>info@robotechsummit.com</span>
                </div>
                <div className="flex items-center space-x-3 text-orange-800">
