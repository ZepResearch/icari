        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 mb-8">
              Get in touch with the RobotechSummit team for any inquiries or support
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="relative bg-white rounded-3xl overflow-hidden h-full shadow-sm border">
                <div className="relative p-8 flex flex-col h-full">
                  ...
                  <p className="text-gray-700 mb-8">
                    Have questions about ICARI 2025? Our team is here to help. Reach out to us using the contact
                  ...
                  <div className="space-y-6 flex-grow">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-black font-medium">info@robotechsummit.com</p>
                      </div>
                    </div>
