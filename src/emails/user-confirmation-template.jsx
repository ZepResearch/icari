...
<head>
    ...
    <style>
        ...
        .registration-details {
            background: linear-gradient(135deg, rgba(234, 88, 12, 0.05) 0%, rgba(249, 115, 22, 0.05) 50%, rgba(251, 146, 60, 0.05) 100%);
            border-left: 4px solid;
            border-image: linear-gradient(135deg, #ea580c 0%, #f97316 50%, #fb923c 100%) 1;
            padding: 25px;
            margin: 30px 0;
        ...
        .conference-info {
            background: linear-gradient(135deg, rgba(234, 88, 12, 0.08) 0%, rgba(249, 115, 22, 0.08) 50%, rgba(251, 146, 60, 0.08) 100%);
            border-radius: 12px;
            padding: 25px;
            margin: 30px 0;
            text-align: center;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>International Conference on AI & Robotics Innovation</p>
        </div>
        <div class="content">
            <p class="greeting">Dear ${data.name},</p>
            <div class="success-badge">✓ Registration Successful</div>
            
            <p>We're thrilled to confirm your registration for the International Conference on AI & Robotics Innovation. Your participation will contribute to groundbreaking discussions on the future of artificial intelligence and robotics technology.</p>
            
            <div class="conference-info">
                <h3>Conference Details</h3>
                <div class="conference-date">November 14th - 15th, 2025</div>
            ...
            <div class="highlight-box">
                <h3>What's Next?</h3>
                <p>We'll send you detailed conference information, including the agenda, speaker lineup, networking opportunities, and venue details as we get closer to the event date. Prepare to explore the cutting-edge of AI and robotics in the vibrant city of Singapore!</p>
            </div>
            
            <p>If you have any questions about AI technologies, robotics demonstrations, or need assistance with your conference experience, please don't hesitate to contact our technical conference team.</p>
            
            <p>We look forward to your valuable contribution to the future of AI and robotics innovation!</p>
            
            <p>Best regards,<br>
            <strong>The ICARI Organizing Committee</strong></p>
        </div>
        <div class="footer">
